...
# Каждый член популяции представляет из себя потенциальное решение проблемы коммивояжера (маршрут)
class Individual:
...
class Population:
    ...
    # Получаем лучшиго члена популяции
...
def crossover(parent_1, parent_2):
    # Выбираем половину генов у первого родителя
...
# Мутация индивида.
# Используя параметр шанс мутации делаем перестановки между генами (по сути меняем в маршруте две точки)
